...
#'
#' @param tau
#' @param scores  a n by n_l matrix of prognostic scores
#' @param x a vector of observation times
#' @param delt_eps a vector of event indicators
#' @param G_hat  a vector of estimated inverse weights
#' @param n_l
#'
#' @return
#' @export
...
#' calculating inverse weights using the KM method
#'
#' @param dat
#' @param tau
#'
...
#'  computing PDI with competing risks data using Fine-Gray model
#'
#' @param dat data
#' @param tau the prespcified inspection time
#' @param n_l number of outcome categories, including event-free
#' @param seed random seed for cross validation
#' @param cv_rep number of cross validation repetitions
